 ...
 *
 * @property {Resource|string} [sourceUri] 用于解析相对链接的 URL 的覆盖。
 ...
 * @constructor
 *
 * @param {string} [name] 数据源的可选名称。如果加载的文档包含名称，则该值将被覆盖。
 *
 ...
 * @param {CzmlDataSource.LoadOptions} [options] 一个对象，指定配置选项。
 *
 * @returns {Promise<CzmlDataSource>} 一个 Promise，解析为新实例，一旦数据被处理。
 */
 ...
 *
 * 一个 CZML 处理函数，根据提供的 CZML 数据包在提供的
 * 集合中添加或更新实体。
 *
 * @param {Entity} entity 实体对象。
 * @param {object} packet CZML 数据包。
 * @param {EntityCollection} entityCollection 实体集合。
 * @param {string} sourceUri 源 URI。
 */
...
/**
 * 将提供的更新器添加到更新器列表中（如果尚未包含）。
 * @private
 * @param {CzmlDataSource.UpdaterFunction} updater 更新器。
 */
 ...
 * @param {CzmlDataSource.LoadOptions} [options] 一个对象，指定配置选项。
 *
 * @returns {Promise<CzmlDataSource>} 一个 Promise，当数据处理完成后解析为该实例。
 */
...
/**
 * 自定义 CZML 更新器函数使用的辅助函数，
 * 该函数从 CZML 数据包创建或更新 {@link PositionProperty}。
 * @function
 *
 * @param {object} object 要添加或更新属性的对象。
 * @param {string} propertyName 对象上属性的名称。
...
/**
 * 自定义 CZML 更新器函数使用的辅助函数，
 * 该函数从 CZML 数据包创建或更新 {@link MaterialProperty}。
 * @function
 *
 * @param {object} object 要添加或更新属性的对象。
 * @param {string} propertyName 对象上属性的名称。
