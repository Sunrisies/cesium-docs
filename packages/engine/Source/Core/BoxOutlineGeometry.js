 ...
 * @param {Cartesian3} options.minimum 盒子的最小 x、y 和 z 坐标。
 * @param {Cartesian3} options.maximum 盒子的最大 x、y 和 z 坐标。
 *
...
/**
 * 根据尺寸创建一个以原点为中心的立方体轮廓。
 *
 * @param {object} options 具有以下属性的对象：
 * @param {Cartesian3} options.dimensions 盒子的宽度、深度和高度，分别存储在 <code>Cartesian3</code> 的 x、y 和 z 坐标中。
 * @returns {BoxOutlineGeometry}
 *
 * @exception {DeveloperError} 所有维度组件必须大于或等于零。
 *
 * @example
...
/**
 * 根据轴对齐包围盒的尺寸创建一个立方体的轮廓。
 *
 * @param {AxisAlignedBoundingBox} boundingBox 对轴对齐包围盒的描述。
 * @returns {BoxOutlineGeometry}
 *
 *
 *
 ...
 * @returns {BoxOutlineGeometry} 修改后的结果参数，如果未提供则返回一个新的 BoxOutlineGeometry 实例。
 */
 ...
 *
 * @param {BoxOutlineGeometry} boxGeometry 对盒子轮廓的描述。
